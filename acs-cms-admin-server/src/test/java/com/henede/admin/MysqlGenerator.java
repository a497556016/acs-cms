...
//			"cms_router"
	...
	private static final String[] prifex = {"sys_", "bus_", "base_", "cms_"};
	private static final String projectPath = "F:\\\\mybatis-plus-auto-code\\\\acs-cms-admin-server\\\\";
...
//        tableFillList.add(new TableFill("user_name", FieldFill.INSERT_UPDATE));
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("hSw.23ms")
                        .setUrl("jdbc:mysql://116.196.91.220:3306/jeicms?characterEncoding=utf8")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                        // .setCapitalMode(true)// 全局大写命名
                        // .setDbColumnUnderline(true)//全局下划线命名
                        .setTablePrefix(prifex)// 此处可以修改为您的表前缀
                        ...
                        // 自定义实体，公共字段
                        .setSuperEntityColumns(new String[]{"createTime","createBy","updateTime","updateBy"})
...
//                        .setSuperControllerClass("com.weishop.base.BaseController")
	...
	private static PackageConfig createPackageConfig() {
        ...
        packageConfig.setModuleName("").setParent("com.henede.admin");// 自定义包路径
        if(createControll) {
